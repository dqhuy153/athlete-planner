...
import { DeletePrivateExercisesHandler } from './commands/delete-private-exercises.handler';
...
import { GetPrivateExerciseUsageHandler } from './queries/get-private-exercise-usage.handler';
...
const QueryHandlers = [
  ...
  GetPrivateExerciseUsageHandler,
];
