 ...
 * instructions format: { level: 'beginner'|'intermediate'|'advanced', steps: string[], form_cues: string[] }
 */
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep shoulder blades retracted', 'Drive feet into the floor', 'Maintain natural arch'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Control the descent', 'Keep elbows at 45 degrees from torso', 'Do not arch excessively'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep core tight and hips level', 'Look slightly forward', 'Full range of motion'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Maintain slight elbow bend throughout', 'Squeeze chest at peak contraction', 'Control the negative'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Lean forward for chest emphasis', 'Control the descent', 'Do not flare elbows excessively'],
      },
    ],
  },
  // ── BACK ────────────────────────────────────────────────────────────────────
    ...
    instructions: [
      {
        ...
        form_cues: ['Bar stays close to body', 'Neutral spine throughout', 'Hips and shoulders rise together'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Initiate with shoulder blades', 'Full hang at bottom', 'Avoid swinging'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep chest up', 'Avoid rounding the lower back', 'Lead with elbows'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep spine neutral', 'Retract shoulder blades at top', 'Do not use momentum'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Initiate pull with lats, not biceps', 'Keep chest up and out', 'Full stretch at top'],
      },
    ],
  },
  // ── SHOULDERS ───────────────────────────────────────────────────────────────
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep core braced', 'Do not flare elbows out', 'Avoid excessive lean back'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Lead with elbows, not wrists', 'Avoid shrugging at the top', 'Control the negative'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Elbows high and wide', 'External rotation at peak', 'Light weight, high reps'],
      },
    ],
  },
  // ── ARMS ────────────────────────────────────────────────────────────────────
    ...
    instructions: [
      {
        ...
        form_cues: ['Do not swing torso', 'Full range of motion', 'Squeeze biceps at the top'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep neutral grip throughout', 'Both arms simultaneously or alternate', 'No momentum'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep elbows pinned to sides', 'Only forearms move', 'Full lockout at bottom'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep upper arms perpendicular to floor', 'Controlled movement only', 'Spotter recommended'],
      },
    ],
  },
  // ── LEGS ────────────────────────────────────────────────────────────────────
    ...
    instructions: [
      {
        ...
        form_cues: ['Chest tall, knees track over toes', 'Brace core at top of breath', 'Hips below parallel for full depth'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Soft knee bend, not a squat', 'Bar stays close to legs', 'Neutral spine throughout'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Do not round your lower back', 'Keep feet flat on platform', 'Do not lock knees at top'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Keep front shin vertical', 'Torso slightly forward for glute emphasis', 'Control the descent'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Full range of motion', 'Avoid raising hips off pad', 'Slow eccentric for more growth'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Full range of motion — deep stretch at bottom', 'Pause at top', 'Avoid bouncing'],
      },
    ],
  },
  // ── ABS ─────────────────────────────────────────────────────────────────────
    ...
    instructions: [
      {
        ...
        form_cues: ['Squeeze glutes and quads', 'Do not let hips sag or pike', 'Breathe steadily'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Avoid swinging', 'Posterior pelvic tilt at top for more ab engagement', 'Control the descent'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Round the spine for full ab contraction', 'Do not pull with arms', 'Keep hips stationary'],
      },
    ],
  },
  {
    ...
    instructions: [
      {
        ...
        form_cues: ['Do not let lower back arch', 'Brace abs throughout', 'Start with small range until strength improves'],
      },
    ],
  },
];
