...
import { createRunningExercise, generateExerciseContent } from '@/lib/api';
  ...
  return (
    <div className="mx-auto max-w-2xl p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {/* Running type */}
        <div>
          <label htmlFor="runningType" className="mb-1 block text-sm font-medium text-on-surface-variant">
            Running type <span aria-hidden className="text-error">*</span>
          </label>
          <select
            id="runningType"
            name="runningType"
          ...
          >
            ...
            {RUNNING_TYPES.map((t) => <option key={t} value={t}>{t}</option>)}
          </select>
        </div>
