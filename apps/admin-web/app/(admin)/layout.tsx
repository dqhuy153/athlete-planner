...
export default function AdminLayout({
  ...
  return (
    <div className='flex h-screen overflow-hidden'>
      ...
      >
        {/* Header */}
        <div className='flex h-14 shrink-0 items-center justify-between border-b border-border px-3 overflow-visible'>
          {/* Left: logo */}
          <div className='flex items-center min-w-0'>
            <LogoBrand variant='mark' size='sm' interactive={false} />
          </div>

          {/* Right: admin label + toggle button */}
          <div className='flex items-center gap-2'>
            ...
            <Button
              ...
              className={cn(
                'h-8 w-8 shrink-0 text-on-surface-variant hover:text-on-surface relative -top-1 z-10',
              )}
            >
              {expanded ? (
