...
const ACTIONS: {
  ...
  },
  {
    ...
    labelKey: 'markRest',
    activeClass:
      'bg-text-tertiary/20 text-text-secondary border-text-tertiary/40',
  },
]
...
export function DayStatusBar({
  ...
  return (
    <div className='flex gap-2 px-4 py-2' role='group' aria-label='Day status'>
